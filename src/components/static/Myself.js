const Myself = [
    {
        "about" : "Hola, I am Priyansh Vyas from Bikaner, Rajasthan, currently a IInd year student pursuing my Engineering degree in Computer Science.",
        "education" : "I have pursued my education from the following institutions :-",
        "ongoing" : "I am currently working on adding the following technologies to my techStack :-",
